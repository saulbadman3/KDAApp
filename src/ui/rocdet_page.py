...
class RocDetPage(ctk.CTkFrame):
    ...
    def _style(self):
        """Applies consistent canvas formatting and matching dark color palette to the subplot objects."""
    ...
    def _plot(self):
        """Computes statistical coordinate arrays, evaluates model diagnostic performance, and updates visual plots."""
        ...
        # Plot ROC and integrate the area under the curve (AUC) metric using the trapezoidal rule
        ...
        # Plot DET and isolate the Equal Error Rate (EER) intersection coordinates
        ...
        # Force layout recalculation and redraw UI component viewport
        self.fig.tight_layout(pad=2)
        self.canvas.draw()